...
//TUNERX CONSTANTS FROM WOODBOT
public class Woodbot {
...
public class Practicebot {
    ...
    private static final int kFrontRightSteerMotorId = 1;
    private static final int kFrontRightEncoderId = 2;
    private static final double kFrontRightEncoderOffset = 0.229248046875;
    ...
    private static final int kBackLeftSteerMotorId = 7;
    private static final int kBackLeftEncoderId = 8;
    private static final double kBackLeftEncoderOffset = -0.416015625;
    ...
    private static final int kBackRightSteerMotorId = 4;
    private static final int kBackRightEncoderId = 5;
    private static final double kBackRightEncoderOffset = -0.25830078125;
    ...
    public static final CommandSwerveDrivetrain practicebot = new CommandSwerveDrivetrain(DrivetrainConstants, FrontLeft,
            FrontRight, BackLeft, BackRight);
}
