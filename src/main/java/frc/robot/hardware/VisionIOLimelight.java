...
public class VisionIOLimelight implements VisionIO {
  ...
  public double getDistanceBlueSourceRight1() {
    return PhotonUtils.calculateDistanceToTargetMeters(height + heightFudgeFactor, 1.22,
        Units.degreesToRadians(pitch + pitchFudgeFactor), 0.0);
  }
  ...
  public double getDistanceRedSpeakerRight3() {
    return PhotonUtils.calculateDistanceToTargetMeters(height + heightFudgeFactor, 1.32,
        Units.degreesToRadians(pitch + pitchFudgeFactor), 0.0);
  }
  ...
  public double getDistanceRedStage11() {
    return PhotonUtils.calculateDistanceToTargetMeters(height + heightFudgeFactor, 1.21,
        Units.degreesToRadians(pitch + pitchFudgeFactor), 0.0);
  }
