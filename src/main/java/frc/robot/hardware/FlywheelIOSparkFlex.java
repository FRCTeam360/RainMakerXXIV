...
public class FlywheelIOSparkFlex implements FlywheelIO {
  ...
  public void updateInputs(FlywheelIOInputs inputs) {
    inputs.flywheelLeftSpeed = leftMotor.get();
    inputs.flywheelRightSpeed = rightMotor.get();
    ...
    inputs.flywheelLeftVoltage = leftMotor.getAppliedOutput();
    inputs.flywheelRightVoltage = rightMotor.getAppliedOutput();
